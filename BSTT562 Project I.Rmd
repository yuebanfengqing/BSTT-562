...
We choose the Method of Meoments to estimate the model parameters.

Why do we choose the Method ofMoments: A good property of MOM: the estimates obtained by MOM are asymptotically efficient.
