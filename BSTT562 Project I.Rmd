...
variance2 <- (sigma_e2 / (y12$beta_i^2 * gamma^2)*(1 + 1 / 5) 
              + sigma_e2 / (y22$beta_i^2 * gamma^2)*(1 + 1 / 5) 
              + sigma_e2 / (y32$beta_i^2 * gamma^2)*(1 + 1 / 5)) / 3^2 + 20^2 * (gamma^2 - 1) / 3

variance3 <- (sigma_e2 / (y13$beta_i^2 * gamma^2)*(1 + 1 / 5) 
              + sigma_e2 / (y23$beta_i^2 * gamma^2)*(1 + 1 / 5) 
              + sigma_e2 / (y33$beta_i^2 * gamma^2)*(1 + 1 / 5)) / 3^2  + 100^2 * (gamma^2 - 1) / 3
...
sigma_e2_sim[i] <- sum(apply((y_LOW - alpha_i_sim[i, ])^2, 1, sum) / 4) / 5 # sigma_e2_sim
...
The Original Results of the analysis of interlaboratory data for Cadmium given in \cite{Bhaumik2005}'s Paper are shown in the table below:
...
Our results are summarized in a table using the same format in below:
...
We can see that our results are very close to theirs.
